...
const appRoutes = [
  {
    ...
    children : [
      ...
      //   'children': [
      //     {
      //       'path': '/fljps/notfConfig/flaNotfConfig', 'name': '/fljps/notfConfig/flaNotfConfig',
      //       'meta': { 'title': '评审配置', 'menuPath': true, 'authCode': 'S100201', 'hideInBread': false, 'menuIcon': 'sound', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/firsttrial/flaFirstTrial', 'name': '/fljps/firsttrial/flaFirstTrial',
      //       'meta': { 'title': '审查管理', 'menuPath': true, 'authCode': 'S100202', 'hideInBread': false, 'menuIcon': 'sound', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/expert/flaOrgaExpert', 'name': '/fljps/expert/flaOrgaExpert',
      //       'meta': { 'title': '组织专家', 'menuPath': true, 'authCode': 'S100203', 'hideInBread': false, 'menuIcon': 'team', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/reviewShow/flaReviewShow', 'name': '/fljps/reviewShow/flaReviewShow',
      //       'meta': { 'title': '评审结果汇总', 'menuPath': true, 'authCode': 'S100204', 'hideInBread': false, 'menuIcon': 'table', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/reportNote/flaReviewNotf', 'name': '/fljps/reportNote/flaReviewNotf',
      //       'meta': { 'title': '范蠡奖申报', 'menuPath': true, 'authCode': 'S100206', 'hideInBread': false, 'menuIcon': 'table', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/review/flaReview', 'name': '/fljps/review/flaReview',
      //       'meta': { 'title': '评审管理', 'menuPath': true, 'authCode': 'S100207', 'hideInBread': false, 'menuIcon': 'table', 'openMode': 'spa' }
      //     },
      //     {
      //       'path': '/fljps/node/nodeConfig','name': '/fljps/node/nodeConfig',
      //       'meta': { 'title': '流程配置','menuPath': true,'authCode': 'S100205','hideInBread': false,'menuIcon': 'appstore', 'openMode': 'spa' }
      //     }
      //   ]
      // },
      // {//中国水产学会团体标准管理
