						...
						<div style="margin:0 16px;">
							<a-row type="flex" justify="start">
								<a-col span="8">
									...
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
											<DetailsItem :labelSpan='8' :textSpan="16" :label='"出生年月"' :text='!detail.birthday?"":detail.birthday.slice(0,7)'></DetailsItem>
										</a-col>
									</a-row>
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
								...
								<a-col span="8">
									...
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
											<DetailsItem :labelSpan='8' :textSpan="16" :label='"年龄"' :text='getAge(detail.birthday)'></DetailsItem>
										</a-col>
									</a-row>
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
											<DetailsItem :labelSpan='8' :textSpan="16" :label='"邮编"' :text='detail.postcode'></DetailsItem>
										</a-col>
									</a-row>
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
						...
						<div style="margin:0 16px;"> -->
							<a-row type="flex" justify="start" class="detailsPartLine">
								<a-col span="8">
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
											<DetailsItem :labelSpan='8' :textSpan="16" :label='"关键词"' :text='detail.topicWord'></DetailsItem>
										</a-col>
									</a-row>
								</a-col>
								<a-col span="16">
									<a-row type="flex" justify="start" class="detailsPartLine">
										<a-col span="24">
											<DetailsItem :labelSpan='4' :textSpan="20" :label='"主要研究领域"' :text='detail.researchDirection'></DetailsItem>
										</a-col>
									</a-row>
								</a-col>
							</a-row>
