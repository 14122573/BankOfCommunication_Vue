        ...
        >
          ...
          >
            <div class="content_wrapper">
              <div class="noti-list" v-for="(item, index) in news[item1.name]" :key="index">
  ...
  methods: {
    ...
    fetchNews() {
      ...
      this.$ajax.get({
        ...
        if(res.code == '200') {
          this.news.farmingTechList = this.$com.confirm(res, 'data.content', [])
        }
      })
      // 科普知识
      this.$ajax
      ...
      this.$ajax
        ...
        .then(res => {
          if(res.code == '200') {
            this.news.cloudLessonList = this.$com.confirm(res, 'data.content', [])
          }
        })
      // this.news.push(
      //   {
